...
void doLCDProgramSellect()
{
  ...
  switch (pos)
  {
    ...
    case 1:
      lcd.setCursor(0, 0);
      lcd.print(">>Carr. Prog: 1 ");
      lcd.setCursor(0, 1);
      lcd.print("Carregar Prog: 2 ");
      break;
    case 2:
      lcd.setCursor(0, 0);
      lcd.print(">>Carr. Prog: 2  ");
      lcd.setCursor(0, 1);
      lcd.print("Carregar Prog: 3 ");
      break;
    case 3:
      lcd.setCursor(0, 0);
      lcd.print(">>Carr. Prog: 3 ");
      lcd.setCursor(0, 1);
      lcd.print("   Sair         ");
      break;
  }
